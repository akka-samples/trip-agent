...
public class TripEndpoint {
  ...
  public String searchTrip(Question question) {
    if (
      !TripSearchState.findEmail(question.question)
  ...
  public FlightBookingResponse getFlight(String id) {
    Flight flight = componentClient
      .forEventSourcedEntity(id)
      .method(FlightBookingEntity::getState)
      .invoke();
  ...
  public AccommodationBookingResponse getAccommodation(String id) {
    Accommodation accommodation = componentClient
      .forEventSourcedEntity(id)
  ...
  public String getWorkflow(String uuid) {
    Optional<TripSearchState> workflowState = componentClient
      .forWorkflow(uuid)
      .method(TripAgentWorkflow::getState)
      .invoke();
