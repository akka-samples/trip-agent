...
public class FlightSearchAgent extends Agent {
  ...
  @FunctionTool(
    name = "find-flights",
    description = "Finds available flights for the given outbound and return dates. Format of the dates must be `2026-05-07T15:00:00Z`"
  )
  private List<FlightAPIResponse> findFlightsTool(String outbound, String returnDate) {
    ...
    return found
      ...
      .filter(flight -> {
        return (
          flight.departure().toLocalDate().equals(outboundParam.toLocalDate()) ||
